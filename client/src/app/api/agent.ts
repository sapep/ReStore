...
axios.defaults.withCredentials = true; // Enable sharing of cookies between front- and backend
...
axios.interceptors.response.use(async response => {
  ...
  switch (status){
    ...
    case 401:
      ...
      break;
    case 403:
      toast.error("The user does not have the required permission to do that!");
      break;
    case 500:
